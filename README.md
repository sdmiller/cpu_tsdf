...
I've adapted a small slice of the Augmented ICL-NUIM dataset, to show an example of this running on notably noisy input data. You can download it at: http://s3.sdavidmiller.com/data/cpu_tsdf_sample_data.zip
